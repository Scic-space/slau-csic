...
function VideoCard({ article }: { article: NewsArticle }) {
    ...
    if (playing && article.video_url) {
        return (
            <div className="flex h-full flex-col rounded-sm border border-border bg-card/80 p-6 transition-all duration-300 hover:border-primary/30">
                <VideoPlayer videoUrl={article.video_url} title={article.title} />
                <div className="mt-3 flex items-center gap-2">
                    <span className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium ${cat?.badge ?? 'border-gray-500/20 bg-gray-500/10 text-muted-foreground'}`}>
                ...
                <h3 className="mt-2 text-base font-semibold tracking-tight text-foreground line-clamp-2 break-words">
                    {article.title}
                </h3>
            </div>
        );
    ...
    return (
        <button
            ...
            className="group flex h-full flex-col rounded-sm border border-border bg-card/80 p-6 text-left transition-all duration-300 hover:border-primary/30 hover:bg-card hover:shadow-lg hover:shadow-black/20"
        >
            {article.thumbnail_url ? (
                ...
                <div className="relative mb-4 flex h-40 items-center justify-center overflow-hidden rounded-sm bg-gradient-to-br from-emerald-500/10 to-purple-500/10">
            ...
            <h3 className="text-base font-semibold tracking-tight text-foreground line-clamp-2 break-words">
                {article.title}
            </h3>
                    ...
                    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            {featured.content_type === 'video' && featured.video_url ? (
                                <div className="rounded-sm border border-indigo-500/20 bg-gradient-to-br from-indigo-500/[0.07] via-purple-500/[0.04] to-transparent p-8 transition-all duration-300 sm:p-10">
                                    ...
                                    <div className="relative">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <span className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium ${categoryConfig[featured.category]?.badge ?? 'border-gray-500/20 bg-gray-500/10 text-muted-foreground'}`}>
                                ...
                                >
                                    <div className="relative overflow-hidden rounded-sm border border-indigo-500/20 bg-gradient-to-br from-indigo-500/[0.07] via-purple-500/[0.04] to-transparent p-8 transition-all duration-300 hover:border-indigo-500/30 hover:shadow-lg hover:shadow-indigo-500/5 sm:p-10">
                                        <div className="pointer-events-none absolute -top-24 -right-24 h-48 w-48 rounded-full bg-indigo-500/10 blur-3xl" />
                ...
                <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                    {articles.length === 0 ? (
                        <div className="rounded-sm border border-border bg-card/80 p-16 text-center">
                            ...
                            <p className="mt-1 text-sm text-muted-foreground">Check back soon for the latest cybersecurity news.</p>
                        </div>
                    ) : (
                            ...
                            {articles.map((article, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex h-full flex-col rounded-sm border border-border bg-card/80 p-6 transition-all duration-300 hover:border-primary/30 hover:bg-card hover:shadow-lg hover:shadow-black/20">
                                                {article.thumbnail_url && (
