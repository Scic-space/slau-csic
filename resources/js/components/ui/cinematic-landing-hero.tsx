...
export function CinematicHero({
  brandName = "SLAU-CSIC",
  logoUrl,
  tagline1 = "Cybersecurity &",
  tagline2 = "Innovations Club",
  cardHeading = "Build, compete, learn.",
  cardDescription = (
    <>
      <span className="text-white font-semibold">SLAU-CSIC</span> is a student-driven community exploring
      cybersecurity, building real-world projects, competing in CTFs, and developing skills that matter.
    </>
  ),
  metricValue = 103,
  metricLabel = "Active Members",
  ctaHeading = "Ready to join?",
  ctaDescription = "No dues, no prerequisites — just curiosity. Join thousands of members building the future.",
  rightContent,
  className,
  ...props
}: CinematicHeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        {logoUrl ? (
          <div className="text-track gsap-reveal mb-6">
            <img
              src={logoUrl}
              alt="SLAU-CSIC logo"
              className="mx-auto h-auto w-72 md:w-96 lg:w-[28rem] drop-shadow-[0_20px_50px_rgba(0,0,0,0.6)] brightness-[1.15] contrast-[1.1]"
            />
          </div>
        ) : (
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="/auth/register" aria-label="Join the Club" className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            ...
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">Join our</div>
              <div className="text-xl font-bold leading-none tracking-tight">Community</div>
            </div>
          </a>
          <a href="/events" aria-label="Browse Events" className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-background">
            <svg className="w-7 h-7 transition-transform group-hover:scale-105" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
            </svg>
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-400 uppercase mb-[-2px]">Browse</div>
              <div className="text-xl font-bold leading-none tracking-tight">Events</div>
            </div>
          </a>
        </div>
      </div>
              ...
              {rightContent ? (
                ...
                <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="absolute inset-[7px] bg-[#050914] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                      ...
                      <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                        <div className="phone-widget flex justify-between items-center mb-8">
                          ...
                          <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">SC</div>
                        </div>
                  ...
                  <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                    ...
                    <div>
                      <p className="text-white text-xs lg:text-sm font-bold tracking-tight">CTF Champions</p>
                      <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Active competitors</p>
                    </div>
                  </div>
                  ...
                  <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Building together</p>
                    </div>
                  </div>
                </div>
              )}
