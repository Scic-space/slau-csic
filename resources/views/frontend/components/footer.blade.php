<footer class="border-t border-white/8 bg-[#07101b]">
    <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {{-- Brand --}}
            <div class="space-y-4">
                <img src="{{ asset('images/university_logo.png') }}" alt="SCIC" class="h-10 w-auto brightness-0 invert">
                ...
                <div class="flex items-center gap-3">
                    <a href="https://github.com/Scic-space" target="_blank" rel="noreferrer" class="text-slate-500 hover:text-white transition-colors" aria-label="GitHub repository">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-3 text-sm text-slate-400">
                    ...
                    <li>
                        <a href="https://github.com/Scic-space" target="_blank" rel="noreferrer" class="inline-flex items-center gap-2 hover:text-white transition-colors">
