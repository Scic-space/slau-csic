...
@section('content')
    <div class="space-y-6">
        <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-border dark:bg-white/[0.03] md:p-8">
            ...
            @if ($resource->details)
                <div class="mb-6 rounded-lg border border-gray-200 bg-background p-5 text-sm leading-7 text-gray-600 dark:border-border dark:bg-background/60 dark:text-gray-400 whitespace-pre-line">
                    {{ $resource->details }}
                </div>
            @endif
