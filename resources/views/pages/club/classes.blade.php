...
@section('content')
    <div class="space-y-3 py-4 sm:py-5">
        ...
        <section class="rounded-sm border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <section class="grid gap-3 xl:grid-cols-[0.95fr_1.05fr]">
            <div class="rounded-sm border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    @forelse ($classes as $class)
                        <article class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900/60">
                            ...
                            <div class="mt-4 flex flex-wrap gap-3">
                                <a href="{{ route('events.show', $class->slug) }}" class="inline-flex items-center gap-2 rounded-sm border border-gray-300 px-3 py-2 text-sm font-medium text-gray-700 dark:border-gray-700 dark:text-gray-200"><span class="material-symbols-outlined" aria-hidden="true">visibility</span>View details</a>
