    ...
    <section class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-border dark:bg-white/[0.03]">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <a href="{{ route('ctf.scoreboard.export', $competition) }}" class="inline-flex items-center gap-1.5 rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-border dark:text-gray-200 dark:hover:bg-white/[0.04]">
