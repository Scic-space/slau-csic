...
@endphp
  <div class="relative flex flex-col items-center justify-center min-h-screen p-6 overflow-hidden z-1">
      ...
      <div class="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
          ...
          <img src="/images/error/404.svg" alt="403" class="dark:hidden" />
          <img src="/images/error/404-dark.svg" alt="403" class="hidden dark:block" />
          ...
          <a href="/"
              class="inline-flex items-center justify-center rounded-lg border border-gray-300 bg-white px-5 py-3.5 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-border dark:bg-card dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
              Back to Home Page
          </a>
      </div>

      <p class="absolute text-sm text-center text-gray-500 -translate-x-1/2 bottom-6 left-1/2 dark:text-gray-400">
          &copy; {{ $currentYear }} - SLAU Cybersecurity Club
      </p>
  </div>
@endsection
