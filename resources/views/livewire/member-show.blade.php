<div class="py-6">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        {{-- Profile Header --}}
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-border dark:bg-card md:p-8">
            ...
            @if ($member['score'] !== null)
                <div class="mt-6 pt-6 border-t border-gray-100 dark:border-border">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div class="rounded-lg border border-gray-200 bg-background p-3 text-center dark:border-border dark:bg-background/60">
                ...
                <div class="mt-6 pt-6 border-t border-gray-100 dark:border-border">
                    ...
                    <div class="space-y-2">
                        @foreach ($member['events_attended'] as $event)
                            <div class="flex items-center gap-3 rounded-lg border border-gray-100 bg-background px-3 py-2 dark:border-border dark:bg-background/60">
                    ...
                    <div class="flex flex-wrap gap-3">
                        @if ($member['github_username'])
                            <a href="https://github.com/{{ $member['github_username'] }}" target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-border dark:bg-card dark:text-gray-300 dark:hover:bg-card-hover">
