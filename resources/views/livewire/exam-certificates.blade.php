                ...
                @foreach ($eligibilities as $eligibility)
                    <div class="rounded-sm border border-gray-200 dark:border-border bg-white dark:bg-card p-4 shadow-sm">
                        ...
                        <div class="mt-4 space-y-2">
                            <a href="{{ route('exams.certificates.download', $eligibility) }}" class="inline-flex w-full items-center justify-center gap-2 rounded-sm border border-gray-300 dark:border-border bg-white dark:bg-card px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 shadow-sm hover:bg-gray-50 dark:hover:bg-card-hover">
