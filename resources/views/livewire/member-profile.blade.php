<div class="py-4 sm:py-5" x-data="{ flash: '' }" x-on:flash.window="flash = $event.detail.message; setTimeout(() => flash = '', 3500)">
    <div>
        ...
        <div x-show="flash" x-transition.duration.300ms
             class="mb-4 rounded-sm border border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-border dark:bg-card">
        ...
        {{-- Photo + Identity card --}}
        <div class="dashboard-card mb-3 rounded-sm border border-gray-200 bg-white p-4 shadow-sm dark:border-border dark:bg-card sm:p-5">
            <div class="flex flex-col items-center gap-4 sm:flex-row">
                <div class="relative shrink-0">
                    ...
                    <label for="profile-photo-upload"
                           class="absolute -bottom-1 -right-1 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full border-2 border-white bg-gray-900 text-white shadow-sm transition hover:bg-gray-700 dark:border-border">
        ...
        <div class="grid grid-cols-1 gap-3 lg:grid-cols-2">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select wire:model="program"
                                    class="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm transition focus:border-gray-900 focus:ring-1 focus:ring-gray-900 disabled:opacity-50 dark:border-border dark:bg-card dark:text-white dark:focus:border-white dark:focus:ring-white dark:disabled:opacity-50">
                        ...
                        <div>
                            ...
                            <textarea wire:model="bio" rows="3"
                                      class="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm transition focus:border-gray-900 focus:ring-1 focus:ring-gray-900 dark:border-border dark:bg-card dark:text-white dark:focus:border-white dark:focus:ring-white"></textarea>
            ...
            <div class="space-y-3">
                <div class="dashboard-card rounded-sm border border-gray-200 bg-white shadow-sm dark:border-border dark:bg-card">
                    <div class="border-b border-gray-100 px-6 py-4 dark:border-border">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="profile-input-group">
                                <span class="inline-flex items-center border-r border-gray-300 bg-gray-50 px-3 text-xs text-gray-500 dark:border-border dark:bg-card dark:text-gray-400">github.com/</span>
                                <input type="text" wire:model="github_username"
                                       class="block w-full rounded-r-lg border-0 bg-white px-3 py-2 text-sm text-gray-900 focus:ring-1 focus:ring-gray-900 dark:bg-card dark:text-white dark:focus:ring-white">
                            </div>
                ...
                <form wire:submit="updatePrivacy" class="px-6 py-5">
                    <div class="space-y-1">
                        ...
                        @foreach ($toggles as $field => $info)
                            <label class="flex cursor-pointer items-center justify-between rounded-lg px-3 py-2.5 transition hover:bg-gray-50 dark:hover:bg-card-hover/50">
                                <div>
                                ...
                                <button type="button" wire:click="$set('{{ $field }}', {{ ${$field} ? 'false' : 'true' }})"
                                    ...
                                    <span class="absolute left-0.5 top-0.5 h-5 w-5 rounded-full bg-white shadow-sm transition-transform duration-200 dark:bg-card {{ ${$field} ? 'translate-x-5' : 'translate-x-0' }}"></span>
                                </button>
                            </label>
                        @endforeach
                    </div>
        ...
        {{-- Badges --}}
        <div class="dashboard-card mt-3 rounded-sm border border-gray-200 bg-white shadow-sm dark:border-border dark:bg-card">
            <div class="border-b border-gray-100 px-6 py-4 dark:border-border">
                <div class="flex items-center justify-between">
                    <div>
        ...
        {{-- Danger Zone --}}
        <div class="dashboard-card mt-3 rounded-sm border border-red-200 bg-white shadow-sm dark:border-red-900/50 dark:bg-card">
                            ...
                            <div class="flex items-end gap-3">
                                <div class="flex-1">
                                    ...
                                    <input type="password" wire:model="delete_password"
                                           class="mt-1 block w-full rounded-lg border border-red-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm transition focus:border-red-500 focus:ring-1 focus:ring-red-500 dark:border-red-700 dark:bg-card dark:text-white">
