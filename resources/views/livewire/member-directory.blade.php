<div class="py-4 sm:py-5">
    <div>
        ...
        <div class="mb-3 rounded-sm border border-gray-200 bg-white p-3 shadow-sm sm:p-4 dark:border-border dark:bg-card">
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <select id="member-filter" wire:model.live="filter" class="block w-full rounded-sm border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-border dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select id="member-year" wire:model.live="year" class="block w-full rounded-sm border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-border dark:bg-gray-700 dark:text-white">
                ...
                <div>
                    ...
                    <select id="member-program" wire:model.live="program" class="block w-full rounded-sm border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-border dark:bg-gray-700 dark:text-white">
        ...
        @else
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                @foreach ($members as $member)
                    <a href="{{ route('members.show', $member['id']) }}" wire:navigate wire:key="member-{{ $member['id'] }}" class="dashboard-card rounded-sm border border-gray-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-md dark:border-border dark:bg-card">
                        ...
                        <div class="mt-3 flex flex-wrap items-center gap-2">
                            ...
                            <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium
                                ...
                                {{ $member['membership_status'] === 'inactive' ? 'bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300' : '' }}">
